...
export default function Services() {
  return (
    <>
      <Helmet>
        <title>Services | A+ Studio Design and Build</title>
        <meta
          name="description"
          content="A+ Studio offers residential construction, interior fit-outs, renovation, and design services in Bulacan, Philippines."
        />

        <meta property="og:title" content="Services | A+ Studio Design and Build" />
        <meta
          property="og:description"
          content="Construction, renovation, and interior design services tailored for modern living."
        />
