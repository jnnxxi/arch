...
export default function Projects() {
  return (
    <>
      <Helmet>
        <title>Projects | A+ Studio Design and Build</title>
        <meta
          name="description"
          content="Explore completed residential and commercial projects by A+ Studio Design and Build in Bulacan and nearby areas."
        />
        <meta property="og:title" content="Projects | A+ Studio Design and Build" />
        <meta
          property="og:description"
          content="View our portfolio of modern residential and commercial construction projects."
        />
