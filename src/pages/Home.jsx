...
export default function HomePage() {
  ...
  return (
    <>
      <Helmet>
        <title>Home | A+ Studio Design and Build</title>
        <meta
          name="description"
          content="A+ Studio Design and Build specializes in residential and commercial construction in Bulacan, Philippines. Quality modern building solutions."
        />

        <meta property="og:title" content="A+ Studio Design and Build" />
        <meta
          property="og:description"
          content="Modern residential and commercial construction services in Bulacan."
        />
          ...
          <div className="mx-auto max-w-5xl px-6">
            ...
            >
              ...
              <button onClick={() => navigate("/contact")}
                className="cursor-pointer mt-10 rounded-xl bg-black px-8 py-4 font-semibold text-white hover:bg-neutral-900 transition">
                Get in Touch
              </button>
            </motion.div>
